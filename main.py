...
class PaintApp:
    ...
    def init_neural_network(self):
        self.neural_network = NeuralNetwork(3, [1024, 32, 10])
        #self.neural_network.load_displacement_vector('parameters/vectors32_4.csv')
        #self.neural_network.load_weights('parameters/matrix32_4.csv')

    def init_dataset(self):
        self.dataset = Dataset('dataSet/Test/annotation.csv', 32*32)
    ...
    def save_weight(self):
        self.neural_network.save_displacement_vector('parameters/vectors32_gui.csv')
        self.neural_network.save_weights('parameters/matrix32_gui.csv')
    ...
    def load_img(self):
        file_types = [("BMP Files", "*.bmp"), ("PNG Files", "*.png"), ("JPEG Files", "*.jpeg"), ("All Files", "*.*")]
    ...
    def take_screenshot(self):
        ...
        #ImageGrab.grab().crop((x, y, x1, y1)).resize((160, 160), resample=Resampling.BOX).save('temp.jpg', 'JPEG', quality=100, subsampling=0)
        ImageGrab.grab().crop((x, y, x1, y1)).save('temp.jpg', 'JPEG', quality=100, subsampling=0)
    ...
    def center_photo(self):
        ...
        new_img.resize((32, 32), resample=Resampling.HAMMING).save('temp_center_resize.jpg', 'JPEG', quality=100, subsampling=0)
