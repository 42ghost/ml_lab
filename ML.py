...
if __name__ == "__main__":
    ...
    #  OUTPUT_DIM = 10                   #
    #  LAYERS_NUM = 3                    #
    #  NEURONS_NUM_IN_FIRST_LAYER - 32   #
    # ================================== #

    # Prepare Dataset
    dataset = Dataset('dataSet/Test/annotation.csv', 32*32)

    # Prepare NeuralNetwork
    a = NeuralNetwork(3, [1024, 32, 10])
    # a.load_displacement_vector('parameters/vectors32_4.csv')
    # a.load_weights('parameters/matrix32_4.csv')

    # Educate NeuralNetwork
    a.network_education('dataset/Learning/annotation.csv', rounds_num=70, learning_speed=0.0004)

    # # Save results
    a.save_displacement_vector('parameters/vectors32_3.csv')
    a.save_weights('parameters/matrix32_3.csv')
